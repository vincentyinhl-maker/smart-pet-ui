...
const LIFE_STAGES = ['1月龄', '3月龄', '6月龄', '9月龄', '12月龄', '成年猫', '老年猫(10岁+)'];
...
export const BREED_STANDARDS = {
  'british-shorthair': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 4000, weightMax: 8000, foodMin: 55,  foodMax: 90,  waterMin: 180, waterMax: 310 },
      { name: '老年猫(10岁+)', weightMin: 3800, weightMax: 7000, foodMin: 50,  foodMax: 80,  waterMin: 175, waterMax: 280 },
    ]
  },
  ...
  'american-shorthair': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3600, weightMax: 6800, foodMin: 55,  foodMax: 88,  waterMin: 160, waterMax: 290 },
      { name: '老年猫(10岁+)', weightMin: 3500, weightMax: 6000, foodMin: 50,  foodMax: 80,  waterMin: 155, waterMax: 270 },
    ]
  },
  ...
  'siamese': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 2500, weightMax: 5500, foodMin: 45,  foodMax: 72,  waterMin: 110, waterMax: 240 },
      { name: '老年猫(10岁+)', weightMin: 2500, weightMax: 5000, foodMin: 42,  foodMax: 68,  waterMin: 110, waterMax: 220 },
    ]
  },
  ...
  'ragdoll': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 4500, weightMax: 9000, foodMin: 68,  foodMax: 110, waterMin: 210, waterMax: 420 },
      { name: '老年猫(10岁+)', weightMin: 4200, weightMax: 8000, foodMin: 62,  foodMax: 100, waterMin: 195, waterMax: 370 },
    ]
  },
  ...
  'persian': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3500, weightMax: 7000, foodMin: 55,  foodMax: 88,  waterMin: 163, waterMax: 310 },
      { name: '老年猫(10岁+)', weightMin: 3200, weightMax: 6500, foodMin: 50,  foodMax: 82,  waterMin: 150, waterMax: 295 },
    ]
  },
  ...
  'maine-coon': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 5000, weightMax: 11000,foodMin: 90,  foodMax: 150, waterMin: 245, waterMax: 540 },
      { name: '老年猫(10岁+)', weightMin: 4800, weightMax: 10000,foodMin: 82,  foodMax: 138, waterMin: 235, waterMax: 490 },
    ]
  },
  ...
  'munchkin': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 2300, weightMax: 4100, foodMin: 42,  foodMax: 65,  waterMin: 112, waterMax: 200 },
      { name: '老年猫(10岁+)', weightMin: 2200, weightMax: 3800, foodMin: 38,  foodMax: 60,  waterMin: 105, weatherMax: 190 },
    ]
  },
  ...
  'sphynx': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3500, weightMax: 7000, foodMin: 62,  foodMax: 98,  waterMin: 170, waterMax: 330 },
      { name: '老年猫(10岁+)', weightMin: 3200, weightMax: 6500, foodMin: 58,  foodMax: 92,  waterMin: 158, waterMax: 305 },
    ]
  },
  ...
  'scottish-fold': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3000, weightMax: 6000, foodMin: 52,  foodMax: 84,  waterMin: 143, waterMax: 280 },
      { name: '老年猫(10岁+)', weightMin: 2800, weightMax: 5500, foodMin: 48,  foodMax: 78,  waterMin: 132, waterMax: 255 },
    ]
  },
  ...
  'dragon-li': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3500, weightMax: 6000, foodMin: 55,  foodMax: 82,  waterMin: 160, waterMax: 275 },
      { name: '老年猫(10岁+)', weightMin: 3300, weightMax: 5500, foodMin: 50,  foodMax: 76,  waterMin: 150, waterMax: 255 },
    ]
  },
  ...
  'mix': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3500, weightMax: 7000, foodMin: 52,  foodMax: 85,  waterMin: 162, waterMax: 312 },
      { name: '老年猫(10岁+)', weightMin: 3300, weightMax: 6500, foodMin: 48,  foodMax: 80,  waterMin: 155, waterMax: 290 },
    ]
  },
  ...
  'custom': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3500, weightMax: 7000, foodMin: 52,  foodMax: 88,  waterMin: 162, waterMax: 315 },
      { name: '老年猫(10岁+)', weightMin: 3300, weightMax: 6500, foodMin: 48,  foodMax: 82,  waterMin: 155, waterMax: 295 },
    ]
  },
  ...
  'bengal': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3600, weightMax: 6800, foodMin: 60,  foodMax: 95,  waterMin: 168, waterMax: 315 },
      { name: '老年猫(10岁+)', weightMin: 3400, weightMax: 6200, foodMin: 55,  foodMax: 88,  waterMin: 158, waterMax: 290 },
    ]
  },
  ...
  'russian-blue': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3500, weightMax: 6500, foodMin: 52,  foodMax: 85,  waterMin: 162, waterMax: 300 },
      { name: '老年猫(10岁+)', weightMin: 3300, weightMax: 6000, foodMin: 48,  foodMax: 78,  waterMin: 152, waterMax: 278 },
    ]
  },
  ...
  'abyssinian': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 2700, weightMax: 5000, foodMin: 48,  foodMax: 76,  waterMin: 128, waterMax: 235 },
      { name: '老年猫(10岁+)', weightMin: 2600, weightMax: 4600, foodMin: 44,  foodMax: 70,  waterMin: 120, waterMax: 215 },
    ]
  },
  ...
  'norwegian-forest': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 4000, weightMax: 9000, foodMin: 78,  foodMax: 135, waterMin: 195, waterMax: 445 },
      { name: '老年猫(10岁+)', weightMin: 3800, weightMax: 8200, foodMin: 72,  foodMax: 125, waterMin: 185, waterMax: 408 },
    ]
  },
  ...
  'birman': {
    ...
    stages: [
      ...
      { name: '成年猫', weightMin: 3500, weightMax: 7000, foodMin: 60,  foodMax: 95,  waterMin: 162, waterMax: 325 },
      { name: '老年猫(10岁+)', weightMin: 3200, weightMax: 6500, foodMin: 55,  foodMax: 88,  waterMin: 150, waterMax: 300 },
    ]
  },
};
